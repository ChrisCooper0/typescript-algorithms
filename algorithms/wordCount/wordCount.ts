// Write a function `wordCount(sentence, targetWords)` that accepts a sentence string and an array of `targetWords`
// The function should return a count of the number of words of the sentence that are in `targetWords`
...
console.log(wordCount("a b c d a b a", ["a", "c"])); // 4
